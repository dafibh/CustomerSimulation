...
class Customer_Type_Param2(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(topFrame, text="Customer Type 2 Parameters", font=controller.title_font)
        ...
        button1 = tk.Button(bottomFrame, text="Back",
                           command=lambda: controller.show_frame("Customer_Type_Param1"), font=controller.button_font,bg="#c8cfca")
        button1.pack()

    def nextPage(self):

        self.controller.customerTypes["t2P"] = int(self.itemPurchaseEntry.get())
        self.controller.customerTypes["t2R"] = int(self.visitsEntry.get())
        
        if self.controller.customerTypesN == 2:
            ...
            self.controller.show_frame("Customer_Type_Param3")